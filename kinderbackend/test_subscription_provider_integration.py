...
def test_external_provider_recurring_purchase_unlocks_access_and_supports_refund(
    ...
    try:
        ...
        gated_before_purchase = client.get("/api/v1/downloads/offline", headers=headers)
        ...
        gated_after_purchase = client.get("/api/v1/downloads/offline", headers=headers)
        assert gated_after_purchase.status_code == 200

        methods = client.get("/api/v1/billing/methods", headers=headers)
        ...
        history_after_purchase = client.get("/api/v1/subscription/history", headers=headers)
        ...
        history_after_refund = client.get("/api/v1/subscription/history", headers=headers)
        ...
        snapshot_after_refund = client.get("/api/v1/subscription/me", headers=headers)
        ...
        synced_methods = client.get("/api/v1/billing/methods", headers=headers)
        visa_method = next(
            item
...
def test_external_provider_incomplete_checkout_keeps_access_gated(
    ...
    try:
        ...
        before_purchase = client.get("/api/v1/downloads/offline", headers=headers)
        ...
        after_attempt = client.get("/api/v1/subscription/me", headers=headers)
        ...
        gated_after_attempt = client.get("/api/v1/downloads/offline", headers=headers)
