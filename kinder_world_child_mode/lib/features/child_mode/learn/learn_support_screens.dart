                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(progress.bestTimeSeconds == null
                              ? (_isArabic
                                  ? 'لا يوجد أفضل وقت بعد'
                                  : 'No best time yet')
                              : (_isArabic
                                  ? 'أفضل وقت: ${_formatTime(progress.bestTimeSeconds!)}'
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            _isArabic
                ? 'اسحبي القطعة إلى مكانها الصحيح. ستلتصق فقط عند التطابق الصحيح.'
